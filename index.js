...
function setTime()
{
    ...
    if(a==hour){
        ...
        document.getElementById("box4").style.backgroundImage="url(girl.svg)"
    ...
    if(x==hour)
    {
        ...
        document.getElementById("box4").style.backgroundImage="url(lunch.png)"
    ...
    if(y==hour)
    {
        ...
        document.getElementById("box4").style.backgroundImage="url(lunch_image.png)"
